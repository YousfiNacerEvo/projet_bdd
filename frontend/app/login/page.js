        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 space-y-2">
            ...
            <div className="border-t border-gray-200 pt-3">
              <p className="text-center text-xs font-medium text-gray-600 mb-1">
                Développé par
              </p>
              <div className="text-center space-y-0.5">
                <p className="text-xs text-gray-500">Yousfi Nacer</p>
                <p className="text-xs text-gray-500">Mahiddine Islem Amine</p>
                <p className="text-xs text-gray-500">Mesbahi Mohammed Abedullah</p>
              </div>
              <div className="mt-2 text-center">
                <a 
                  href="https://github.com/YousfiNacerEvo/projet_bdd"
                  target="_blank"
